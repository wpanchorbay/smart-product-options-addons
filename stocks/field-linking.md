...
![Reduction Mode dropdown open showing options](../public/img/stock-field-link-reduction.png)
...
- ![Custom Formula field visible under Reduction Mode](../public/img/stock-field-link-formula.png)
- **Available Variables:**
...
![Frontend view showing an out of stock option selection disabled](../public/img/stock-frontend-outofstock.png)
