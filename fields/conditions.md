...
![The Conditions tab inside an expanded field row in the Addon Builder, showing the Enable toggle, Action, Match Type, and two configured rules](../public/img/field-conditions-tab.png)
