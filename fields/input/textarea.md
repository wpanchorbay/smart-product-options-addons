...
![Backend view of General settings for Textarea field](../../public/img/field-textarea-general.png)
...
![Backend view of Validation settings for Textarea field](../../public/img/field-textarea-validation.png)
...
![Backend view of Restrictions settings for Textarea field](../../public/img/field-textarea-restrictions.png)
...
![Backend view of Pricing settings for Textarea field](../../public/img/field-textarea-pricing.png)
...
- **Price Type:** Choose how the price is calculated.
  ...
  - *Character Count:* Charges a set amount per character typed. The price updates live on the frontend as the customer types. This is highly useful for long-form text that has a per-word or per-letter cost.
...
![Backend view of Conditions tab for Textarea field](../../public/img/field-textarea-conditions.png)
...
*Example:* Show the "Special Instructions" textarea only when the customer selects "Custom Order" from a previous dropdown.
...
![Backend view of Stock tab for Textarea field](../../public/img/field-textarea-stock.png)
...
![Textarea field rendered on the frontend product page](../../public/img/field-textarea-frontend.png)
