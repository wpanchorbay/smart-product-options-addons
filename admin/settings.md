...
![The General Settings section highlighting swatch dimensions and roundness controls](../public/img/settings-swatch-size-roundness.png)
...
![The System & Maintenance settings area highlighting the Debug Mode toggle and the Delete Data on Uninstall warning checkbox](../public/img/settings-system-maintenance.png)
